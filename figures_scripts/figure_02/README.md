...
On Windows, the wrapper in `external_tools_launch/naviflux/run_naviflux_windows.ps1`
uses `npm.cmd` explicitly to avoid PowerShell execution-policy failures.

In the NAViFluX interface:

1. Upload Options -> Model File -> `figures_scripts/figure_02/outputs/naviflux/e_coli_core_figure_01_reactions.xml`
2. Upload Options -> Reaction Weight File -> `figures_scripts/figure_02/outputs/naviflux/naviflux_reaction_weights_figure_01_reactions.csv`
3. Upload Options -> Flux Weight File -> `figures_scripts/figure_02/outputs/naviflux/naviflux_flux_weights_figure_01_reactions.csv`
...
with open("figures_scripts/figure_02/outputs/naviflux/e_coli_core_figure_01_reactions.xml", "rb") as f:
