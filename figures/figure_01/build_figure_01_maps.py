...
def main() -> None:
    ...
    kegg_fragment, kegg_meta = crop_escher_map(
        kegg_map,
        map_name="figure_01_rn00010_kegg_fragment",
        map_description="Cropped KEGG rn00010 fragment for Figure 1.",
    )
    ecoli_fragment, ecoli_meta = crop_escher_map(
        ecoli_map,
        map_name="figure_01_rn00010_ecoli_core_fragment",
        map_description="Cropped BioEMMA map of e_coli_core on rn00010 for Figure 1.",
    ...
    flux_fragment[0]["map_name"] = "figure_01_rn00010_ecoli_core_flux_fragment"
