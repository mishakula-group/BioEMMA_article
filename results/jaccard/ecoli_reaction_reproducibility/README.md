...
Models: 57 BiGG Escherichia coli models; excluded: `e_coli_core`.
...
- `ecoli_reaction_frequency_by_pathway.tsv`: core/variable reaction frequency across selected models.
