...
- Fluxer GUI upload should use the SBML model `data/e_coli_core.xml`; the publication bundle also keeps a copy as `results/external_tool_comparison/fluxer_upload_model.xml`.
